...
public class SyncService extends IntentService {
    ...
    private static final String ACTION_FETCH_NEW_POSTS_FROM_COLLECTION =
            "fr.ec.producthunt.data.action.FETCH_NEW_POSTS_FROM_COLLECTION";
    ...
    public static void startSyncPostsFromCollection(Context context, String url) {
        Intent intent = new Intent(context, SyncService.class);
        intent.setAction(ACTION_FETCH_NEW_POSTS_FROM_COLLECTION);
    ...
    private void handleActionFetchNewPostsFromCollection(String url) {

        DataProvider.getInstance(this.getApplication()).syncPostFromCollection(url);
        Intent intentToSend = new Intent();
        intentToSend.setAction(ACTION_LOAD_POSTS);
        LocalBroadcastManager.getInstance(this).sendBroadcast(intentToSend);
    }
